...
export class SpecializationService {
  ...
  creeateDoctorCategory(doctorCategory: {
    name: string;
    descritption: string;
  }): Observable<DoctorSpecialization> {
  ...
  updateDoctorCategory(
    ...
    doctorCategory: DoctorSpecialization
  ): Observable<DoctorSpecialization> {
  ...
  changeStatusOfCategory(
    ...
    return this.http.patch<DoctorSpecialization>(
      `${this.apiUrl}/change-status/${doctorCategoryId}`,
      null
    );
  }
