...
export class FeedService {
  ...
  getPostsOfDoctorById(doctorId:string):Observable<any> {
    return this.http.get<any>(`${this.apiUrl}/get-doctor-post/${doctorId}`)
  }
  ...
  toggleSavePost(postId:string):Observable<any>{
    return this.http.post<any>(`${this.apiUrl}/p/${postId}/toggle-save`,{})
  }
