...
@Component({
  ...
  imports:[MatDatepickerModule, MatFormFieldModule,
    MatInputModule,MatDateRangePicker,CommonModule,FormsModule ,AppoinmentListComponent,
    PatientProfileComponent,UserSidebardetailsListingComponent,
    UserPaginationComponent
  ],
  templateUrl: './AppoinmentListing.component.html',
  styleUrls: ['./AppoinmentListing.component.css'],
  providers: [
