...
import { ErrorNotificationService } from '../../../../shared/Services/NotificationPopups/Error-Notification.service';
import { ConfirmationService, MessageService } from 'primeng/api';
import { ConfirmDialogModule } from 'primeng/confirmdialog';
import { ToastModule } from 'primeng/toast';
import { FormBuilder, FormGroup, Validators } from '@angular/forms';
import { SuccessNotificationService } from '../../../../shared/Services/NotificationPopups/Success-Notification.service';
@Component({
  ...
  templateUrl: './specializationTable.component.html',
  styleUrls: ['./specializationTable.component.css'],
...
export class SpecializationTableComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, private confirmationService: ConfirmationService, private messageService: MessageService,private specializationService:SpecializationService,private toastrService: ErrorNotificationService,private toastSuccessService:SuccessNotificationService ) { }
  ...
  submitForm(specialization: { _id:string,name: string, description: string, isBlocked: boolean ,isEditing: boolean }): void {
   console.log(specialization)
    if (!this.isValidSpecialization(specialization)) {
      this.toastrService.showErrorNotification('Form is invalid', 'Error');
      return;
    }
