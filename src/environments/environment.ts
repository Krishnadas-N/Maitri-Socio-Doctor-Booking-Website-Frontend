export const environment = {
  ...
  SOCKET_URL:'fsonline.shop',
  UserServiceUrl:'fsonline.shop/api/users',
  DoctorServiceUrl:'fsonline.shop/api/doctors',
  AdminServiceUrl:'fsonline.shop/api/admin',
  FeedService:'fsonline.shop/api/posts',
  OtpService:'fsonline.shop/api/otp',
  ChatService:'fsonline.shop/api/chat',
  SpeciailizationService:'fsonline.shop/api/spec',
